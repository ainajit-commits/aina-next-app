export default function Footer() {
    return (
        <footer className="bg-sky-400 text-slate-300 mt-20">
  <div className="max-w-7xl mx-auto px-6 py-12">
    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
      <div className="md:col-span-1">
        <span className="text-2xl font-bold text-red-800 ">YourLogo</span>
        <p className="mt-4 text-sm text-white">Xxx</p>
      </div>

      <div>
        <h4 className="text-sm font-semibold text-red-800 uppercase tracking-wider">Xxx</h4>
      ...
      <div>
        <h4 className="text-sm font-semibold text-red-800 uppercase tracking-wider">Subscribe</h4>
        <p className="mt-4 text-sm text-white">Xxx</p>
